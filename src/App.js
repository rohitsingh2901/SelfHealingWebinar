...
function App() {
  return (
    ...
    <div id='maindiv' className='row'>
      ...
      <div id='Poster2' className='col-6 flex flex-col items-center justify-center'>
      <h1 className='font-extrabold text-orange-600 text-center' >You want to start today?</h1>
      <Player
      playsInline
      poster="/assets/poster.png"
      src="https://rr5---sn-qxaelney.c.drive.google.com/videoplayback?expire=1699702203&ei=iztPZd7lBoy1mvUP1p2raA&ip=103.211.18.97&id=d7c91cfdaca59963&itag=22&source=webdrive&requiressl=yes&xpc=EghonaK1InoBAQ==&mh=Kc&mm=32&mn=sn-qxaelney&ms=su&mv=m&mvi=5&pl=24&ttl=transient&susc=dr&driveid=1D_RrgR3qO5arpBm1sUIzrgCLYaKBoVc-&app=explorer&eaua=FeBO4f3VXs4&mime=video/mp4&vprv=1&prv=1&dur=8120.621&lmt=1699545545663080&mt=1699691323&subapp=DRIVE_WEB_FILE_VIEWER&txp=0001224&sparams=expire,ei,ip,id,itag,source,requiressl,xpc,ttl,susc,driveid,app,eaua,mime,vprv,prv,dur,lmt&sig=ANLwegAwRQIgKnLMJ-IcsNhK9MNEdIZGXYZGNG-aWrfnSa7dMREiuh0CIQC7IBXv-YbRIV97ft9Ad3DRwPu9TC2ILm-zcjrPCb0UhA==&lsparams=mh,mm,mn,ms,mv,mvi,pl&lsig=AM8Gb2swRQIgfc9gM1uaH2SCw3kQuPQ11IoDr71iR3veeN8NS95cL0ICIQCZu0h7p8pXim-ynn000xZk9AJIMm-CyPq4LS7HSRaDXA==&cpn=CfmSbLOPo38yIKaE&c=WEB_EMBEDDED_PLAYER&cver=1.20231107.01.00"
      />
